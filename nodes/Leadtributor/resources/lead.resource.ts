		...
		options: [
			{
				...
				description: 'Maximum distance in kilometers for location-based matching (default: 2)',
			},
			{
				...
				description: 'Minimum duplicate score (1–100) a candidate must reach to be included (default: 50)',
			},
		],
	},
	{
